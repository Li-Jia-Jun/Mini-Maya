...
public:
    ...
    // Polar Spherical attributes and functions

    float angleX;       // Rotation angles about world X and Y asix in radian
    float angleY;       // Rotation angles about world Y asix in radian
    float radiusLen;    // Length between eye and ref

    void PolarRotateAlongUp(float deg);
    void PolarRotateAlongRight(float deg);
    void PolarTranslateAlongForward(float amt);

    void PolarRecomputeAttribute();
    void PolarInitializeAttribute();
};
