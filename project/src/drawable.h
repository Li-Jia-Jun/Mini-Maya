...
protected:
    ...
    GLuint bufVertInfluenceIDs;
    GLuint bufVertInfluenceWeights;

    bool idxBound; // Set to TRUE by generateIdx(), returned by bindIdx().
    bool posBound;
    bool norBound;
    bool colBound;
    bool vertInfluenceIDsBound;
    bool vertInfluenceWeightsBound;
...
public:
    ...
    void generateNor();
    void generateCol();
    void generateVertInfluenceIDs();
    void generateVertInfluencecWeights();

    bool bindIdx();
    bool bindPos();
    bool bindNor();
    bool bindCol();
    bool bindVertInfluenceIDs();
    bool bindVertInfluenceWeights();
};
