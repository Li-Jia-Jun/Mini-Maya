...
public:
    // For skeleton shader
    int attrVertInfluenceIDs;
    int attrVertInfluenceWeights;

    int unifBindMatrics;
    int unifTransformationMats;
    int unifDualQuatT;
    int unifDualQuatR;
    int unifTransformationDualQuatT;
    int unifTransformationDualQuatR;

    void setBindMatrics(glm::mat4 bindMats[100]);
    void setTransformationMatrics(glm::mat4 tMats[100]);
    void setDualQuatT(glm::quat dualQuatT[100]);
    void setDualQuatR(glm::quat dualQuatR[100]);
    void setTransformationDualQuatT(glm::quat dualQuatT[100]);
    void setTransformationDualQuatR(glm::quat dualQuatR[100]);
